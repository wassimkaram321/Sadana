...
<div class="content container-fluid">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <form class="plan-form" action="{{route('admin.sales-man.work-plan-update',[$plan['id']])}}" method="POST"
                            ...
                            <div class="row">
                                <div class="col-md-6 col-sm-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date" value="{{$plan->begin_plan}}" name="begin_plan" class="form-control"
                                             required>
                                    </div>
                                ...
                                <div class="col-md-6 col-sm-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date" value="{{$plan->end_plan}}" name="end_plan" class="form-control"
                                            required>
                                    </div>
                                ...
                                <div class="col-md-6 col-sm-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text"  value="{{$plan->note}}" name="note" class="form-control" placeholder="Note" required>
                                    </div>
                                ...
                                <div class="col-md-6 col-sm-12">
                                    ...
                                    <select
                                        ...
                                        @foreach($salesman as $s)
                                            <option
                                                value="{{$s['id']}}" {{ $s->id==$plan->saler_id ? 'selected' : ''}} >{{$s['name']}}</option>
                                        @endforeach
                                ...
                                <div class="col-md-12 col-sm-12">
                                    ...
                                    <select class="js-example-basic-single" multiple="multiple" name="pharamcies_ids[]">
                                        ...
                                        <option value="{{$p->id }}" {{is_array($pharmaciesSelectedArray) && in_array($p->id, $pharmaciesSelectedArray) ? 'selected' : '' }}> {{$p->name}}</option>
                                        @endforeach
