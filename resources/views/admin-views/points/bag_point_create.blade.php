...
@section('title', \App\CPU\translate('Bag Points Add'))
<style>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    {{ \App\CPU\translate('Add')}} {{ \App\CPU\translate('new')}} {{ \App\CPU\translate('Bag Points')}}
                </div>
                <div class="card-body" style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};">
                    <form action="{{route('admin.points.bag_points_store')}}" method="post" enctype="multipart/form-data">
                        @csrf
