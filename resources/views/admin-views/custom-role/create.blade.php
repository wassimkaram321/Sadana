                    ...
                    <div class="card-body">
                        <form id="submit-create-role" method="post" action="{{ route('admin.custom-role.store') }}"
                                ...
                                <div class="col-md-3">
                                    <div class="form-group form-check">
                                        <input type="checkbox" name="modules[]" value="order_management"
                                            class="form-check-input" id="order">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group form-check">
                                        <input type="checkbox" name="modules[]" value="product_management"
                                            class="form-check-input" id="product">
                                        <label class="form-check-label"
                                            style="{{ Session::get('direction') === 'rtl' ? 'margin-right: 1.25rem;' : '' }};"
                                ...
                                <div class="col-md-3">
                                    <div class="form-group form-check">
                                        <input type="checkbox" name="modules[]" value="marketing_section"
                                            class="form-check-input" id="marketing">
                                        <label class="form-check-label"
                                            style="{{ Session::get('direction') === 'rtl' ? 'margin-right: 1.25rem;' : '' }};"
                                ...
                                <div class="col-md-3">
                                    <div class="form-group form-check">
                                        <input type="checkbox" name="modules[]" value="business_section"
                                            class="form-check-input" id="business_section">
                                        <label class="form-check-label"
                                            style="{{ Session::get('direction') === 'rtl' ? 'margin-right: 1.25rem;' : '' }};"
                                ...
                                <div class="col-md-3">
                                    <div class="form-group form-check">
                                        <input type="checkbox" name="modules[]" value="user_section"
                                            class="form-check-input" id="user_section">
                                        <label class="form-check-label"
                                            style="{{ Session::get('direction') === 'rtl' ? 'margin-right: 1.25rem;' : '' }};"
                                ...
                                <div class="col-md-3">
                                    <div class="form-group form-check">
                                        <input type="checkbox" name="modules[]" value="support_section"
                                            class="form-check-input" id="support_section">
                                        <label class="form-check-label"
                                            style="{{ Session::get('direction') === 'rtl' ? 'margin-right: 1.25rem;' : '' }};"
                                ...
                                <div class="col-md-3">
                                    <div class="form-group form-check">
                                        <input type="checkbox" name="modules[]" value="business_settings"
                                            class="form-check-input" id="business_settings">
                                        <label class="form-check-label"
                                            style="{{ Session::get('direction') === 'rtl' ? 'margin-right: 1.25rem;' : '' }};"
                                ...
                                <div class="col-md-3">
                                    <div class="form-group form-check">
                                        <input type="checkbox" name="modules[]" value="web_&_app_settings"
                                            class="form-check-input" id="web_&_app_settings">
                                        <label class="form-check-label"
                                            style="{{ Session::get('direction') === 'rtl' ? 'margin-right: 1.25rem;' : '' }};"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group form-check">
                                        <input type="checkbox" name="modules[]" value="employee_section"
                                            class="form-check-input" id="employee_section">
                                        <label class="form-check-label"
                                            style="{{ Session::get('direction') === 'rtl' ? 'margin-right: 1.25rem;' : '' }};"
                                ...
                                <div class="col-md-3">
                                    <div class="form-group form-check">
                                        <input type="checkbox" name="modules[]" value="pos_management"
                                            class="form-check-input" id="pos_management">
                                        <label class="form-check-label"
                                            style="{{ Session::get('direction') === 'rtl' ? 'margin-right: 1.25rem;' : '' }};"
                                ...
                                {{-- add Distribution management ( Distribution section , delivery_man_management ) --}}
                                <div class="col-md-3">
                                    <div class="form-group form-check">
                                        <input type="checkbox" name="modules[]" value="delivery_man_management"
                                            class="form-check-input" id="delivery_man_management">
                                        <label class="form-check-label"
                                            style="{{ Session::get('direction') === 'rtl' ? 'margin-right: 1.25rem;' : '' }};"
                                ...
                                {{--  --}}
                                {{-- add Salesman management ( Salesman section , sales_man_management ) --}}
                                <div class="col-md-3">
                                    <div class="form-group form-check">
                                        <input type="checkbox" name="modules[]" value="sales_man_management"
                                            class="form-check-input" id="sales_man_management">
                                        <label class="form-check-label"
                                            style="{{ Session::get('direction') === 'rtl' ? 'margin-right: 1.25rem;' : '' }};"
                                            for="sales_man_management">{{ \App\CPU\translate('Salesman_management') }}</label>
                                    </div>
                                </div>
                                {{--  --}}
