                ...
                <div class="navbar-vertical-content mt-2">
                    <ul class="navbar-nav navbar-nav-lg nav-tabs">
                        ...
                        @if (\App\CPU\Helpers::module_permission_check('product_management'))
                            ...
                            <!--Pharmacy section-->
                            <li
                                class="navbar-vertical-aside-has-menu {{ Request::is('admin/pharmacy*') ? 'active' : '' }}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle"
                                    href="javascript:">
                                    <i class="tio-pharmacy nav-icon"></i>
                                    <span
                                        class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{ \App\CPU\translate('Pharmacies') }}</span>
                                </a>
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                            ...
                            <li
                                ...
                                <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle"
                                    ...
                                    <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                        <span
                                            class="text-truncate">{{ \App\CPU\translate('InHouse Products') }}</span>
                                    </span>
                                </a>
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                        ...
                        -->
                                    ...
                                    <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                        ...
                                        <li class="nav-item {{ Request::is('admin/employee/add-new') ? 'active' : '' }}">
                                            <a class="nav-link " href="{{ route('admin.employee.add-new') }}">
                                                <span class="tio-circle nav-indicator-icon"></span>
                                                <span
                                                    class="text-truncate">{{ \App\CPU\translate('add_new') }}</span>
                                            </a>
                                        </li>
                                    ...
                                    <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                        ...
                                        <li
                                            ...
                                            <a class="nav-link"
                                                ...
                                                <span class="tio-circle nav-indicator-icon"></span>
                                                <span
                                                    class="text-truncate">{{ \App\CPU\translate('scheduling') }}</span>
                                                <span class="badge badge-soft-info badge-pill ml-1">
                                                    {{ \App\Model\Order::where('order_type', 'default_type')->where(['order_status' => 'pending'])->count() }}
                                                </span>
                                            </a>
                                        </li>
                                        {{-- <li class="nav-item {{Request::is('admin/delivery-trip/scheduling-list')?'active':''}}">
                            ...
                            @if (\App\CPU\Helpers::module_permission_check('sales_man_management'))
                                <li class="nav-item {{ Request::is('admin/sales-man*') ? 'scroll-here' : '' }}">
                                    <small
                                        class="nav-subtitle">{{ \App\CPU\translate('sales_man_management') }}</small>
                                    <small class="tio-more-horizontal nav-subtitle-replacer"></small>
                                </li>
