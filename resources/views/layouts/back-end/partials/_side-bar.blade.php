                ...
                <div class="navbar-vertical-content mt-2">
                    <ul class="navbar-nav navbar-nav-lg nav-tabs">
                        ...
                        <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/pharmacy*') ? 'active' : '' }}">
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                style="display: {{ Request::is('admin/pharmacy*') ? 'block' : 'none' }}">
                                {{-- <li class="nav-item {{Request::is('admin/store/add-new')?'active':''}}">
                                    <a class="nav-link " href="{{route('admin.store.add-new')}}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span class="text-truncate">{{\App\CPU\translate('add_new')}}</span>
                        ...
                        <li
                            class="nav-item {{ Request::is('admin/customer/list') || Request::is('admin/sellers/seller-add') || Request::is('admin/sellers/seller-list') ? 'scroll-here' : '' }}">
                        ...
                        <li
                            class="nav-item {{ Request::is('admin/currency/view') || Request::is('admin/business-settings/refund*') || Request::is('admin/business-settings/language*') || Request::is('admin/business-settings/shipping-method*') || Request::is('admin/business-settings/payment-method') || Request::is('admin/business-settings/seller-settings*') ? 'scroll-here' : '' }}">
                        ...
                        {{-- <li
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                ...
                                <li
                                    class="nav-item {{Request::is('admin/business-settings/refund/list/pending')?'active':''}}">
                                    <a class="nav-link"
                                ...
                                <li
                                    class="nav-item {{Request::is('admin/business-settings/refund/list/approved')?'active':''}}">
                                    <a class="nav-link"
                                ...
                                <li
                                    class="nav-item {{Request::is('admin/business-settings/refund/list/refunded')?'active':''}}">
                                    <a class="nav-link"
                                ...
                                <li
                                    class="nav-item {{Request::is('admin/business-settings/refund/list/rejected')?'active':''}}">
                                    <a class="nav-link"
                        ...
                        <li
                            class="nav-item {{ Request::is('admin/delivery-man*') || Request::is('admin/delivery-trip*') ? 'scroll-here' : '' }}">
                            <small class="nav-subtitle">{{ \App\CPU\translate('delivery_man_management') }}</small>
                            <small class="tio-more-horizontal nav-subtitle-replacer"></small>
                        </li>

                        <li
                            class="navbar-vertical-aside-has-menu {{ Request::is('admin/delivery-man/add') || Request::is('admin/delivery-man/list') ? 'active' : '' }}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle" href="javascript:">
                                <i class="tio-user nav-icon"></i>
                                <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                style="display: {{ Request::is('admin/delivery-man/add') || Request::is('admin/delivery-man/list')  ? 'block' : 'none' }}">
                        ...
                        <li
                            class="navbar-vertical-aside-has-menu {{ Request::is('admin/delivery-trip*') ? 'active' : '' }}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle" href="javascript:">
                                <i class="tio-car nav-icon"></i>
                                <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                style="display: {{ Request::is('admin/delivery-trip*') ? 'block' : 'none' }}">

                                <li
                                    class="nav-item {{ Request::is('admin/delivery-trip/scheduling') ? 'active' : '' }}">
                                    <a class="nav-link"
                                        href="{{ route('admin.delivery-trip.scheduling', ['pending']) }}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                        ...
                        <li
                            class="navbar-vertical-aside-has-menu {{ Request::is('admin/delivery-man/reviews*') ? 'active' : '' }}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                                href="{{ route('admin.delivery-man.delivery-reviews') }}">
                                <i class="tio-star nav-icon"></i>
                                <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                        ...
                        <li
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                style="display: {{ Request::is('admin/sales-man*') ? 'block' : 'none' }}">
