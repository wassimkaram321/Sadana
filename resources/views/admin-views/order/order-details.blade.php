                    ...
                    @if($order->customer)
                        <div class="card-body">
                            <div class="media align-items-center" href="javascript:">
                                ...
                                {{-- <div class="media-body">
                                    <span
                                        class="text-body text-hover-primary">{{$order['customer_type']}}</span>
                                 </div> --}}
...
<script>
    ...
    {{-- <script
        src="https://maps.googleapis.com/maps/api/js?key={{\App\CPU\Helpers::get_business_settings('AIzaSyCeSycFWU-UA_Q56WeJBAWXYm3RJKSSU0k')}}&v=3.45.8"></script>
    <script>
