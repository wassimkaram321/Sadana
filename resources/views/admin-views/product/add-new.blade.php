                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <label for="name"
                                            style="width: 100%;">{{ \App\CPU\translate('Brand') }}</label>
                                        <select
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <label for="name">{{ \App\CPU\translate('Production date') }}</label>
                                         <input type="date"  step="0.01" name="production_date"
                                        class="js-example-basic-multiple form-control" style="width: 100%;">
                                    </div>
                                    <!--expiry date dateit-->
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                        ...
                        <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <label for="name">{{ \App\CPU\translate('Quantity featured offer') }}</label>
                                         <input type="number" min="0" value="0" step="0.01" name="q_featured_offer"
                                        class="js-example-basic-multiple form-control" style="width: 100%;">
                                    </div>
                                    <!--Unit-->
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <label for="name">{{ \App\CPU\translate('featured offer') }}</label>
                                        <input type="number" min="0" value="0" step="0.01" name="featured_offer"
                                        class="js-example-basic-multiple form-control" style="width: 100%;">
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        ...
                                        <input type="number" min="0" value="0" step="0.01" name="q_normal_offer"
                                        class="js-example-basic-multiple form-control" style="width: 100%;">
                                    </div>
                                    <!--Normal offer-->
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <label for="name">{{ \App\CPU\translate('Normal offer') }}</label>
                                        <input type="number" min="0" value="0" step="0.01" name="normal_offer"
                                        class="js-example-basic-multiple form-control" style="width: 100%;">
                                    </div>
                                </div>
