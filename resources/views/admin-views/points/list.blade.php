...
@section('title', \App\CPU\translate('Products Points List'))
                                ...
                                @foreach($productpoint as $k=>$b)
                                    ...
                                    <tr>
                                        ...
                                        @php
                                            ...
                                            $name = Product::whereIn('id',$it)->get()->toArray();
                                        @endphp
...
@push('script')
    <script>
        $(document).on('click', '.delete', function () {
            var id = $(this).attr("id");
            Swal.fire({
                title: '{{ \App\CPU\translate('Are_you_sure_delete_this_product_points')}}?',
                ...
                if (result.value) {
                    ...
                    $.ajax({
                        url: "{{route('admin.points.points_delete')}}",
                        method: 'POST',
                        data: {id: id},
                        success: function () {
