    ...
    <div class="content container-fluid">
        ...
        <div class="row gx-2 gx-lg-3">
            <div class="col-sm-12 col-lg-12 mb-3 mb-lg-2">
                <div class="card">
                    <div class="card-body">
                        <form action="{{route('admin.sales-man.update',[$sales_man['id']])}}" method="post"
                            ...
                            <div class="row">
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="{{$sales_man['f_name']}}" name="f_name"
                                               class="form-control" placeholder="New sales-man"
                                               required>
                                    </div>
                                </div>
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="{{$sales_man['l_name']}}" name="l_name"
                            ...
                            <div class="row">
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="email" value="{{$sales_man['email']}}" name="email" class="form-control"
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="phone" value="{{$sales_man['phone']}}" class="form-control"
                                               placeholder="Ex : 017********"
                                               required>
                                    </div>
                                </div>
